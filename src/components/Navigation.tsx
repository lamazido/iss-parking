      ...
      >
        <div className="container">
          <div className="flex lg:flex-nowrap flex-wrap items-center">
            ...
            <div
              className="navigation hs-collapse transition-all duration-300 lg:basis-auto basis-full grow hidden items-center justify-center lg:flex mx-auto overflow-hidden mt-6 lg:mt-0"
              id="navbarCollapse"
            >
              <ul
            ...
            <div className="ms-auto shrink hidden lg:inline-flex gap-2">
              <a
                href="#"
                className="py-2 px-6 inline-flex items-center gap-2 rounded-md text-base text-white bg-orange-500 hover:bg-orange-600 transition-all duration-500 font-medium"
              >
                <IconifyIcon
